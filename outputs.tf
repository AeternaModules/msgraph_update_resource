output "update_resources_id" {
  description = "Map of id values across all update_resources, keyed the same as var.update_resources except keys with no id are omitted"
...
output "update_resources_api_version" {
  description = "Map of api_version values across all update_resources, keyed the same as var.update_resources except keys with no api_version are omitted"
...
output "update_resources_body" {
  description = "Map of body values across all update_resources, keyed the same as var.update_resources except keys with no body are omitted"
...
output "update_resources_ignore_missing_property" {
  description = "Map of ignore_missing_property values across all update_resources, keyed the same as var.update_resources except keys with no ignore_missing_property are omitted"
...
output "update_resources_output" {
  description = "Map of output values across all update_resources, keyed the same as var.update_resources except keys with no output are omitted"
...
output "update_resources_read_query_parameters" {
  description = "Map of read_query_parameters values across all update_resources, keyed the same as var.update_resources except keys with no read_query_parameters are omitted"
...
output "update_resources_response_export_values" {
  description = "Map of response_export_values values across all update_resources, keyed the same as var.update_resources except keys with no response_export_values are omitted"
...
output "update_resources_retry" {
  description = "Map of retry values across all update_resources, keyed the same as var.update_resources except keys with no retry are omitted"
...
output "update_resources_update_method" {
  description = "Map of update_method values across all update_resources, keyed the same as var.update_resources except keys with no update_method are omitted"
...
output "update_resources_update_query_parameters" {
  description = "Map of update_query_parameters values across all update_resources, keyed the same as var.update_resources except keys with no update_query_parameters are omitted"
...
output "update_resources_url" {
  description = "Map of url values across all update_resources, keyed the same as var.update_resources except keys with no url are omitted"
